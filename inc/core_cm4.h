...
/* Direct CMSIS Version Definitions (Replaces cmsis_version.h) */
...
*/
/* Deterministic GCC Floating Point Unit (FPU) Detection */
#if defined (__VFP_FP__) && !defined(__SOFTFP__)
  #if defined (__FPU_PRESENT) && (__FPU_PRESENT == 1U)
    #define __FPU_USED       1U
  #else
    #error "Compiler flags enabled FPU (-mfloat-abi=hard), but __FPU_PRESENT is 0 in stm32f446xx.h!"
...
/* Direct GCC Compiler Attributes & Core Intrinsics (Replaces cmsis_compiler.h) */
#define __ASM                    __asm
